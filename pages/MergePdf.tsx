  ...
  return (
    <div className="max-w-4xl mx-auto py-12 px-4">
      <div className="text-center mb-8">
        <h1 className="text-3xl font-extrabold text-slate-900 mb-2">Merge PDF Files</h1>
        <p className="text-slate-600">Combine multiple PDFs into one document in seconds.</p>
      </div>
        ...
        {files.length === 0 ? (
          <div className="border-2 border-dashed border-slate-200 rounded-2xl p-12 text-center hover:border-blue-500 transition-colors cursor-pointer group">
            ...
            <label htmlFor="pdf-upload" className="cursor-pointer">
              ...
              <h3 className="text-lg font-semibold text-slate-900 mb-2">Select PDF Files</h3>
              <p className="text-slate-500 text-sm mb-4">or drag and drop them here</p>
          ...
          <div>
            <div className="space-y-3 mb-8">
              ...
              <div className="pt-4 flex justify-center">
                ...
                />
                <label htmlFor="pdf-add-more" className="text-blue-600 text-sm font-bold cursor-pointer hover:underline flex items-center">
                  <span className="text-lg mr-1">+</span> Add more files
                </label>
              </div>
            </div>
      ...
      <div className="mt-12 text-slate-500 text-sm text-center">
        <p className="mb-4 font-semibold uppercase tracking-widest">How it works</p>
