...
const Pricing: React.FC = () => {
  ...
  const startRazorpayPayment = async (planName: string, price: number) => {
    ...
    try {
      const res = await fetch('fetch(`${import.meta.env.VITE_BACKEND_URL}/create-order`)', {
        method: 'POST',
    ...
    <div className="max-w-7xl mx-auto py-20 px-4">
      <div className="text-center mb-16">
        <h1 className="text-5xl font-black text-slate-900 mb-6">
          Simple Pricing, <span className="text-blue-600">No Surprises</span>
        </h1>
          ...
          return (
            ...
            >
              ...
              <button
                disabled={isActive}
                onClick={() =>
                  startRazorpayPayment(plan.name, Number(plan.price))
                }
